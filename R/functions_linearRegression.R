...
#' computes the sum squares for a model
#' @export
...
#' creates the full model creation from the model
#' @param data the data frame for the model to implement
...
#' returns the model with the summary
#' @param data the data frame for the model to implement
#' @param y the dependent variable
#' @export
...
#' @param data the data frame for the model to implement
#' @param y the dependent variable
#' @param x the list of all the regressors
#' @param interaction which regressors will have interaction
#' @param summary if you wish to include the summary of the model
#' @export
...
#' @param model the model to test the significance
...
#' @param data the data frame for the model to implement
#' @param threshhold the required distance for between the Rsquare and adjRsquare
#' @export
...
#' @param updatedModel the model to test the significance
#' @param alpha the level of significance
#' @export
...
#' @param updatedModel the model to test the significance
#' @param alpha the level of significance
#' @param categorical if any of the variables is categorical
#' @param message if you want to return a string that prints the conclusion
#' @export
...
#' @note prints the regressors that best fit a normal distribution. prints the regressors that are corrolated with the dependent variable. prints most corrolated variable between regressors
#' @param data the df that will be using
#' @param alpha the level of significance
#' @param message if you want to return a result
#' @export
...
#' @param model the linear model to test
#' @param alpha the level of significance
#' @param message if you want to return a result
#' @param units a list of all the units to include
#' @param intercept if you want to include the intercept
#' @export
...
#' Prints the most significant regressors in a linear model without the summary
#' @param model the linear model to test
#' @param alpha the level of significance
#' @param message if you want to return a result
#' @param units a list of all the units to include
...
#' prints all the interactions terms from a data set, excluding the first column which is treated as the dependent variable.
